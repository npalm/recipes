---
title: "Chocolate Panna Cotta with Orange Jelly"
...
waitTime: 180
difficulty: medium
tags: ["dessert", "chocolate", "orange", "panna cotta", "italian"]
images: []
...
- 2.5 sheets gelatin {scale}
- 200 ml heavy cream {scale}
- 20 g sugar {scale}
- 75 g dark chocolate {scale}
- 50 ml strong coffee {scale}
...
- 100 ml fresh orange juice {scale}
- 0.5 sheets gelatin (from the previously soaked 2.5 sheets) {scale}
- 1 tsp sugar (optional) {scale}
...
5. When the panna cotta in the glasses is thick enough (after about {{1-1.5}} hours), carefully pour a thin layer of orange jelly over the panna cotta.
...
- 40 g powdered sugar {scale}
- 25 g butter {scale}
- 15 g flour {scale}
- 20 ml fresh orange juice {scale}
- 0.5 tsp orange marmalade {scale}
...
Serve the panna cotta in glasses with 1-2 orange tuiles on the side or on top. Optionally garnish with some grated orange zest or a sprig of mint.
