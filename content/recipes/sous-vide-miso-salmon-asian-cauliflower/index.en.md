---
title: "Sous Vide Miso Salmon with Asian Cauliflower"
...
cookTime: 45
difficulty: medium
tags: ["main", "fish", "salmon", "sous-vide", "asian", "miso"]
images: []
...
- 2 salmon filets {scale}
- 1 tsp miso paste {scale}
- 3 cloves garlic, finely chopped {scale}
- 3 spring onions, thinly sliced {scale}
- 1 tbsp ginger, grated {scale}
- 1 tsp honey {scale}
- Sesame seeds
...
- 3 tbsp soy sauce (or tamari) {scale}
- 1 tbsp honey or maple syrup {scale}
- 1 tsp ginger, freshly grated or powdered {scale}
- 2 cloves garlic, pressed {scale}
- 1 to 2 tsp sambal badjak {scale}
...
- 4 tbsp olive oil {scale}
- 2 tbsp soy sauce {scale}
- Juice of 1/2 lime {scale}
- 1 tsp mirin {scale}
- 1 tsp ginger, grated {scale}
- 1 spring onion, thinly sliced {scale}
- 1/2 clove garlic, finely chopped {scale}
