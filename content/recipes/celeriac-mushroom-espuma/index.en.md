...
- 100 g {scale} wild mushrooms (or chestnut mushrooms), quartered
- 1 {scale} shallot, finely chopped
- 1 {scale} garlic clove, finely chopped
- 15 g {scale} butter
- 1 sprig fresh thyme {scale}
...
### Celeriac Espuma - For the Siphon
...
- 250 g {scale} celeriac, peeled and diced
- 100 ml {scale} heavy cream (minimum 30% fat)
- 50 ml {scale} whole milk
- 1 sprig fresh thyme {scale}
- 1 tsp lemon juice {scale}
- Salt and pepper to taste
- 1 N2O charger (for siphon/whipper)

**Note:** This component requires a siphon or espuma whipper.
...
1. Divide the warm mushrooms between two plates and stack them in the center.
2. Shake the siphon once more and hold it upside down.
3. Dispense a generous dome of celeriac espuma on top of the mushrooms.
4. Garnish immediately with a tuft of crispy celeriac straw on top of the espuma.
5. Serve immediately.
